      ...
      <div class="detail-group">
        ...
        <div style="margin-top:40px">
          ...
          { rules: [{ required: true, message: '发起类型' }] },
                ...
                @change="handleSelectChange"
              >
                <a-select-option value="female1">类型1</a-select-option>
                <a-select-option value="female2">类型2</a-select-option>
                <a-select-option value="female3">类型3</a-select-option>
                <a-select-option value="female4">类型4</a-select-option>
                <a-select-option value="female5">类型5</a-select-option>
                <a-select-option value="female6">类型6</a-select-option>
                <a-select-option value="female7">类型7</a-select-option>
